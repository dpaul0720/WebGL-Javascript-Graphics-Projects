...
window.onload = function init()
{
    ...
    // 5th parameter: specifies the offset in bytes
    // between the beginning of consecutive vertex attributes
    // 6th parameter: specifies an offset in bytes of
    // the first component of the first vertex attribute
    // in the array
    gl.vertexAttribPointer( vPosition, 2, gl.FLOAT, false, 2*4+3*4, 0 );
    ...
    // the first component of the first vertex attribute
    // in the array
    gl.vertexAttribPointer( vColor, 3, gl.FLOAT, false, 2*4+3*4, 2*4 );
