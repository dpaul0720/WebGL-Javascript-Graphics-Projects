...
*/
    ...
    // in general, you should compute the normal matrix given the modelview matrix, normalMatrix() is defined in MV.js
    nMatrix = normalMatrix(modelViewMatrix, true); // return 3 by 3 normal matrix
