...
gasket5: Generates Sierpinski Gasket by recursion from slider input

pidarts: Evaluate the value of PI with animation function, show three ways to print information.
...
rotatingSquare1: Rotating square with radio button for turning on or off the rotation
