...
window.onload = function init()
{
    ...
    // Most application programmers prefer to have the shaders read in by the
    // application from text files rather than embedded them in the HTML file
    var program = initShaders( gl, "gasket1v2-vshader.glsl",
                              "gasket1v2-fshader.glsl" );
